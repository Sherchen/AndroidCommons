...
/**
 * 通用的adapter
 * Encapsulate the listview fill operation
 * @param <Entity> The data entity class
 * @param <ViewHolder> The ViewHolder class
 */
public abstract class ItemAdapter<Entity, ViewHolder> extends BaseAdapter {
    ...
    public ItemAdapter(Context context, int paramInt) {
        m_Context = context;
    ...
    public ItemAdapter(Context context, int layoutResId, List<Entity> list){
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        ViewHolder holder;
        if ((convertView == null) || (convertView.getTag(R.id.common_tag_glide) == null)) {
            convertView = mInflater.inflate(getLayoutResource(position), null);
            holder = getViewHolder(convertView);
            bindView(holder, convertView);
            convertView.setTag(R.id.common_tag_glide, holder);
        }
        holder = (ViewHolder) convertView.getTag(R.id.common_tag_glide);
