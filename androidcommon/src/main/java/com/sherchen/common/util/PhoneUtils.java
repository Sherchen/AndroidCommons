...
public final class PhoneUtils {
    ...
    public static String getWiFiManagerMac(Context context){
     ...
     * @return
     */
    public static String getCombineUniqueId(Context context){
        String m_szLongID = getIMEI() + getPseudoUniqueId() + DeviceUtils.getAndroidID() + getWiFiManagerMac(context) + getBTMac(context);
// compute md5
